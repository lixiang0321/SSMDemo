...
public class DatabaseConnection {
    ...
    public static final String DBURL = "jdbc:mysql://localhost:3306/blogs?useUnicode=true&characterEncoding=UTF-8" ;
    public static final String USER = "root" ;
    public static final String PASSWORD = "Lixiang0321" ;
